...
def main(argv):
    ...
    The code is take from https://github.com/open-mmlab/mmsr and modified
...
'''
    ...
    try:
      opts, args = getopt.getopt(argv,"ha:b:",["help","gtDir=","genDir="])
    except getopt.GetoptError:
      print('calculate_PSNR_SSIM.py -a <gtDir> -b <genDir>')
      sys.exit(2)
    for opt, arg in opts:
      if opt in ('-h', '--help'):
         print('calculate_PSNR_SSIM.py -a <gtDir> -b <genDir>')
         ...
         folder_GT = arg
      elif opt in ("-b", "--genDir"):
        folder_Gen = arg

    print('GT filedir is ', folder_GT)
    print('Gen filedir is', folder_Gen)
